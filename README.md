# 🐝 Cilium Policy Studio
> Design secure L3-L7 Kubernetes container networking rules. Scaffold CiliumNetworkPolicies, inspect live traffic flows, and debug DNS blocks using Hubble flow telemetry.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/cilium-policy/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/cilium-policy/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-cilium-policy.git
cd tp-cilium-policy
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/cilium-policy/) |
